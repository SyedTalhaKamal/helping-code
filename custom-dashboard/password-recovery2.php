                            ...
                            <form action="password-recovery3.php">
                                <div class="form-field mb-2">
                                    <div class="label-field">
                                        <label for="" class="custom-label">Verification Code <span class="red">*</span></label>
                                    </div>
                                    <div class="input-field">
                                        <input type="text" class="custom-input pl-3" placeholder="Enter Verification Code">
                                    </div>
                                </div>
                                <div class="form-field text-right mb-5">
                                    <div class="forget-password-text">
                                        <a href="#_">Resent Code</a>
                                    </div>
                                </div>
