    ...
    <div class="container-fluid p-0 pb-5">
      <div class="row">
        ...
        <div class="col-lg-6 text-left text-lg-right mt-4 mt-lg-0">
          <a href="blocked-user.php" class="main-transparent-btn h-40 px-5 mb-3 mb-sm-0">Blocked Users</a>
        </div>
      </div>
      <div class="row mt-4">
        <div class="col-12">
                      ...
                      <tr>
                        ...
                        <td>
                          <div class="dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                              <a class="dropdown-item" href="user-detail.php"><i class="fas fa-eye mr-3 yellow-icon"></i>View</a>
                              <a class="dropdown-item" href="#"  data-toggle="modal" data-target="#block"><i class="fas fa-ban mr-3 red-icon"></i>Unblock</a>
                            </div>
                          </div>
                        </td>
                      </tr>
