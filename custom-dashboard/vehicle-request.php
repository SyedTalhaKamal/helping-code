                        ...
                        <td>
                          <div class="dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                              <a class="dropdown-item" href="vehicle-request-detail.php"><i class="fas fa-eye mr-3 yellow-icon"></i>View</a>
                              <a class="dropdown-item" href="#"><i class="fas fa-times mr-3 red-icon"></i>Reject</a>
                              <a class="dropdown-item" href="#"><i class="fas fa-check mr-3 green-icon"></i>Approved</a>
                            </div>
                          </div>
                        </td>
                      </tr>
