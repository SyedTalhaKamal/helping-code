          ...
          <div class="custom-card py-5 px-2 px-md-3 px-lg-4 px-xl-5">
            <div class="row">
              ...
              <div class="col-md-4  order-0 order-md-1 mb-3 mb-md-0">
                <h5 class="active-inactive-red mt-4 pl-4 pl-md-0"><span></span>Blocked</h5>
              </div>
            </div>
            ...
            <div class="row px-4">
              ...
              <div class="col-md-9">
                <div class="custom-btn">
                  <a href="#_" class="main-fill-btn-grey h-50 px-5 mb-3 font-bold">PAY REQUEST</a>
