        ...
        <div class="col-lg-12">
          <div class="dashboard-back-btn">
            <a href="drivers.php">
              ...
              <h2 class="main-general-heading">Request Amount Release</h2>
            </a>
          </div>
        </div>
      </div>
                        ...
                        <td>
                          <div class="dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                              <a class="dropdown-item" href="blocked-drivers.php"><i class="fas fa-check mr-3 green-icon"></i>Delivered</a>
                            </div>
                          </div>
                        </td>
                      </tr>
