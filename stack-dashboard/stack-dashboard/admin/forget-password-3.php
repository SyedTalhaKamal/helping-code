                    ...
                    <div class="text-center mt-3">
                        ...
                        <form action="login.php">
                            <div class="form-field mt-1">
                                <input type="password" class="site-input pl-0 right-icon confirm-input" placeholder="New Password" name="" id="">
                                <i class="fa fa-eye-slash confirm-icon right-icon" aria-hidden="true"></i>
                            </div>
                            <div class="form-field">
                                <input type="password" class="site-input pl-0 right-icon enter-input" placeholder="Re-Type Password" name="" id="">
