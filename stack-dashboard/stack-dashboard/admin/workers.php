                        ...
                        <div class="card my-sm-5 mx-2">
                            <div class="card-content collapse show">
                                <div class="card-dashboard">
                                    <div class="row">
                                        <div class="col-12">
                                            <h5 class="mb-2 semi-bold d-grey-text">Workers</h5>
                                        </div>
                                    </div>
                                    <div class="row ml-0 mr-0">
                                        <div class="col-12 text-right">
                                            <button class="site-btn px-sm-3 px-2 py-1 mb-1 p-sm" onclick="location.href='add-worker.php'">Add Workers</button>
                                        </div>
                                                    ...
                                                    <td>
                                                        <div class="btn-group custom-dropdown ml-2 mb-1">
                                                            ...
                                                            <div class="dropdown-menu text-left custom-dropdown"> 
                                                                <a href="worker-details.php" class="dropdown-item d-flex align-items-center justify-content-start"><i class="fas mr-1 fa-eye"></i>View Profile</a>
                                                                <a href="#_" data-toggle="modal" data-target=".inactiveUser" class="dropdown-item d-flex align-items-center justify-content-start">
                                                                ...
                                                                <a href="worker-ticket-logs.php" class="dropdown-item ml-1 d-flex align-items-center justify-content-start">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="btn-group custom-dropdown ml-2 mb-1">
                                                            ...
                                                            <div class="dropdown-menu text-left custom-dropdown"> 
                                                                <a href="worker-details.php" class="dropdown-item d-flex align-items-center justify-content-start"><i class="fas mr-1 fa-eye"></i>View Profile</a>
                                                                <a href="#_" data-toggle="modal" data-target=".activeUser" class="dropdown-item d-flex align-items-center justify-content-start">
                                                                    <svg class="mr-1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="41" height="35" viewBox="0 0 41 35">
                                                                        <defs>
                                                                            <filter id="Ellipse_25" x="0" y="0" width="35" height="35" filterUnits="userSpaceOnUse">
                                                                            <feOffset dy="3" input="SourceAlpha"/>
        ...
        <div class="modal-content admin-modal">
            <div class="text-center">
                ...
                <div class="d-sm-flex align-items-center justify-content-center mt-3">
                    ...
                    <button class="px-2 py-1 site-btn" data-dismiss="modal" aria-label="Close">Make Active</button>
                </div>
            </div>
        </div>
    </div>
...
<div class="modal fade inactiveUser" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content admin-modal">
            <div class="text-center">
                <img src="images/question.png" alt="" class="img-fluid">
                <h5 class="d-grey-text mt-1">Are you sure you want to make this user Inactive?</h5>
                <div class="d-sm-flex align-items-center justify-content-center mt-3">
                    <button class="px-3 py-1 site-btn blue-border-btn mr-sm-1" data-dismiss="modal" aria-label="Close">Cancel</button>
                    <button class="px-2 py-1 site-btn" data-dismiss="modal" aria-label="Close">Make Inactive</button>
                </div>
            </div>
        </div>
    </div>
