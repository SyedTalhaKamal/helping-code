                    ...
                    <div class="col-12 px-xl-4 pt-xl-2">
                        <nav aria-label="breadcrumb" class="mt-sm-5 mx-2">
                            <ol class="breadcrumb mb-0">
                                <li class="breadcrumb-item blue-text"><a href="workers.php">Workers</a></li>
                                <li class="breadcrumb-item blue-text active" aria-current="page">Edit Worker</li>
                            </ol>
                        </nav>
                        <div class="card mb-sm-5 mx-2">
                            <div class="card-content collapse show">
                                <div class="card-dashboard">
                                    <div class="row">
                                        <div class="col-12">
                                            <h5 class="mb-2 semi-bold d-grey-text">Edit Worker</h5>
                                        </div>
                                    </div>
                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                ...
                                                <div class="text-center mt-1">
                                                    <a href="#_" class="blue-text">Upload Picture</a>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-lg-6 mt-1">
                                                <label for="" class="semi-bold d-grey-text">Phone Number</label>
                                                <input type="number" value="21232123" class="dash-input p-1">
                                            </div>
                                            <div class="col-lg-6 mt-1">
                                                <label for="" class="semi-bold d-grey-text">Rate</label>
                                                <div class="d-flex align-items-center">
                                                    <input type="number" class="dash-input p-1">
                                                    <p class="mb-0 semi-bold ml-1">$/hr</p>
                                                </div>
                                            </div>
                                            <div class="col-12 text-center mt-5">
                                                <button class="site-btn px-sm-3 px-2 py-1" type="submit">Update</button>
                                            </div>
                                        </div>
                                    </form>
