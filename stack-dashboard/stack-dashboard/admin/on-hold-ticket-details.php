                ...
                <div class="row">
                    <div class="col-12">
                        <nav aria-label="breadcrumb" class="mt-sm-5 mx-2">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item blue-text"><a href="on-hold-tickets.php">On-Hold tickets</a></li>
                        ...
                        <div class="card d-block mt-2 mt-sm-0 mx-2">
                            <div class="card-content collapse show">
                                <div class="card-dashboard">
                                    <div class="row">
                                        <div class="col-12">
                                            <h5 class="mb-2 d-grey-text">On Hold Tickets</h5>
                                        </div>
                                        <div class="col-12">
                                            <div class="d-md-flex align-items-center justify-content-between">
                                                ...
                                                <div>
                                                    ...
                                                    <p class="mb-0 text-md-right semi-bold"><span class="d-blue-text">Rate: </span> 10% Off</p>
                                                </div>
                                            </div>
                                            <div class="d-sm-flex align-items-center justify-content-end">
                                                <button class="site-btn red-border-btn px-2 mr-sm-1 py-1 p-xs" data-toggle="modal" data-target=".markIncomplete">Mark as Incomplete</button>
                                                <button class="site-btn px-2 py-1 p-xs" data-toggle="modal" data-target=".markComplete">Mark as Complete</button>
                                            </div>
                                            <hr>
                                            <div class="d-sm-flex align-items-center justify-content-between">
                                                <h5 class="mb-0 d-blue-text">Ticket no. <span class="blue-text"> 1321</span></h5>
                                                <p class="mb-0 semi-bold red-text"><span class="d-blue-text">Priority: </span> ASAP</p>
                                            </div>
                                            <hr>
                                            ...
                                            <div class="d-xl-flex align-items-center justify-content-between">
                                                <div>
                                                    <p class="p-lg mb-0 mt-1 mt-xl-0 semi-bold d-blue-text">Workers</p>
                                                    <p class="mb-0 medium d-grey-text">User Name</p>
                                                    <p class="mb-0 medium d-grey-text">User Name</p>
                                                    <p class="mb-0 medium d-grey-text">User Name</p>
                                                </div>
                                                <div>
                                                    <p class="p-lg mb-0 mt-1 mt-xl-0 semi-bold d-blue-text">Rate</p>
                                                    <p class="mb-0 medium d-grey-text">$120/hr <a href="#_" class="blue-text p-xs"> Edit</a></p>
                                                    <p class="mb-0 medium d-grey-text">$120/hr <a href="#_" class="blue-text p-xs"> Edit</a></p>
                                                    <p class="mb-0 medium d-grey-text">$120/hr <a href="#_" class="blue-text p-xs"> Edit</a></p>
                                                </div>
                                                <div class="text-xl-center mt-1 mt-xl-0">
                                                    <p class="p-lg mb-0 semi-bold red-text">Waiting for admin to mark ticket as complete</p>
                                                    <p class="mb-0 medium l-red-text">This Worker Has Mark The Ticket As Solved</p>
                                                    <p class="mb-0 medium l-red-text">This Worker Has Mark The Ticket As Solved</p>
                                                    <p class="mb-0 medium l-red-text">This Worker Has Mark The Ticket As Solved</p>
                                                </div>
                                                <div>
                                                    <p class="p-lg mb-0 mt-1 mt-xl-0 semi-bold d-blue-text">Total Hours</p>
...
<div class="modal fade markComplete" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content admin-modal">
            <div class="text-center">
                <img src="images/question.png" alt="" class="img-fluid">
                <h5 class="d-grey-text mt-1">Are you sure you want to mark ticket as complete?</h5>
                <div class="d-sm-flex align-items-center justify-content-center mt-3">
                    ...
                    <button class="px-2 py-1 site-btn" data-dismiss="modal" aria-label="Close">Close Ticket</button>
                </div>
            </div>
        </div>
    </div>
...
<div class="modal fade markIncomplete" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content admin-modal">
            <div class="text-center">
                <img src="images/question.png" alt="" class="img-fluid">
                <h5 class="d-grey-text mt-1">Are you sure you want to mark ticket as incomplete?</h5>
                <div class="d-sm-flex align-items-center justify-content-center mt-3">
                    <button class="px-3 py-1 site-btn blue-border-btn mr-sm-1" data-dismiss="modal" aria-label="Close">Cancel</button>
                    <button class="px-2 py-1 site-btn" data-dismiss="modal" aria-label="Close">Close Ticket</button>
                </div>
