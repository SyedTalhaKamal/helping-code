                ...
                <div class="row">
                    <div class="col-12">
                        <nav aria-label="breadcrumb" class="mt-sm-5 mx-2">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item blue-text"><a href="unassigned-tickets.php">Unassigned tickets</a></li>
                        ...
                        <div class="card d-block mt-2 mt-sm-0 mx-2">
                            <div class="card-content collapse show">
                                <div class="card-dashboard">
                                    <div class="row">
                                        <div class="col-12">
                                            <h5 class="mb-2 d-grey-text">Unassigned Tickets</h5>
                                        </div>
                                        <div class="col-12">
                                            ...
                                            <div class="d-sm-flex align-items-center justify-content-between">
                                                ...
                                                <p class="mb-0 semi-bold green-text"><span class="d-blue-text">Priority: </span> Normal</p>
                                            </div>
                                            <hr>
                                            ...
                                            <div class="d-sm-flex align-items-center justify-content-between">
                                                ...
                                                <button class="site-btn mt-sm-0 mt-1 px-3 py-1" data-toggle="modal" data-target=".takeJob">Take Jobs</button>
                                            </div>
                                            <div class="row">
                                                <div class="col-xl-4 col-lg-6">
                                                    <select class="js-example-basic-multiple" name="workers[]" multiple="multiple">
                                                        <option value="woA">Worker A</option>
                                                        <option value="woB">Worker B</option>
                                                        <option value="woC">Worker C</option>
                                                        <option value="woD">Worker D</option>
                                                    </select>
                                                </div>
                                            </div>
                                            <button class="site-btn mt-1 px-2 py-1" data-toggle="modal" data-target=".assignWorkers">Assign Workers</button>
                                            <hr>
