                    ...
                    <div class="col-12 px-xl-4 pt-xl-2">
                        <nav aria-label="breadcrumb" class="mt-sm-5 mx-2">
                            <ol class="breadcrumb mb-0">
                                ...
                                <li class="breadcrumb-item blue-text active" aria-current="page">Add User</li>
                            </ol>
                        </nav>
                        <div class="card mb-sm-5 mx-2">
                            <div class="card-content collapse show">
                                <div class="card-dashboard">
                                    <div class="row">
                                        <div class="col-12">
                                            <h5 class="mb-2 semi-bold d-grey-text">Add User</h5>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-12">
                                        ...
                                        <div class="col-12 mt-5">
                                            <button class="site-btn px-4 py-1" data-target=".userRegistered" data-toggle="modal">Register</button>
                                        </div>
                                    </div>
