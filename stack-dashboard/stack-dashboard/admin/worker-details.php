                    ...
                    <div class="col-12 px-xl-4 pt-xl-2">
                        <nav aria-label="breadcrumb" class="mt-sm-5 mx-2">
                            <ol class="breadcrumb mb-0">
                                ...
                                <li class="breadcrumb-item blue-text active" aria-current="page">Worker Profile</li>
                            </ol>
                        </nav>
                        <div class="card mb-sm-5 mx-2">
                            <div class="card-content collapse show">
                                <div class="card-dashboard">
                                    <div class="row">
                                        <div class="col-12">
                                            <h5 class="mb-2 semi-bold d-grey-text">Worker Profile</h5>
                                        </div>
                                    </div>
                                    <div class="row">
                                        ...
                                        <div class="col-xl-6 mx-auto">
                                            <div class="row">
                                                ...
                                                <div class="col-lg-6 mt-1 mt-lg-2 pl-lg-5">
                                                    <label for="" class="semi-bold">Rate</label>
                                                    <p class="mb-0 m-grey-text">$ 120/hr</p>
                                                </div>
                                                <div class="col-lg-6 mt-1 mt-lg-2 pl-lg-5">
                                                    <label for="" class="semi-bold">Phone Number</label>
                                                    <p class="mb-0 m-grey-text">1231231</p>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-12 text-center mt-5">
                                            <button class="site-btn px-3 py-1" onclick="location.href='edit-worker.php'">Edit Details</button>
                                        </div>
                                    </div>
