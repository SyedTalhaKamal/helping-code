                        ...
                        <div class="card my-sm-5 mx-2">
                            <div class="card-content collapse show">
                                <div class="card-dashboard">
                                    <div class="row">
                                        <div class="col-12">
                                            <h5 class="mb-2 semi-bold d-grey-text">On Hold Tickets</h5>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-12 d-md-flex align-items-center justify-content-between">
                                            <div class="d-md-flex align-items-center">
                                                ...
                                                <select class="dash-input p-1 mt-1 w-300">
                                                    ...
                                                    <option value="">Newly Created First</option>
                                                </select>
                                            </div>
                                                    ...
                                                    <td>
                                                        <div class="btn-group custom-dropdown ml-2 mb-1">
                                                            ...
                                                            <div class="dropdown-menu custom-dropdown"> 
                                                                <a href="on-hold-ticket-details.php" class="dropdown-item"><i class="fas fa-eye"></i>View</a>
                                                                <a href="#_" class="dropdown-item"><i class="fas fa-check"></i>Close</a>
                                                            </div>
                                                        </div>
                                                    </td>
                                                </tr>
