                        ...
                        <div class="card my-sm-5 mx-2">
                            <div class="card-content collapse show">
                                <div class="card-dashboard">
                                    <div class="row">
                                        <div class="col-12">
                                            <h5 class="mb-2 semi-bold d-grey-text">Users</h5>
                                        </div>
                                    </div>
                                    <div class="row ml-0 mr-0">
                                        <div class="col-12 text-right">
                                            <button class="site-btn px-sm-3 px-2 py-1 mb-1 p-sm" onclick="location.href='add-user.php'">Add Users</button>
                                        </div>
                                                    ...
                                                    <td>
                                                        <div class="btn-group custom-dropdown ml-2 mb-1">
                                                            ...
                                                            <div class="dropdown-menu text-left custom-dropdown"> 
                                                                <a href="user-details.php" class="dropdown-item d-flex align-items-center justify-content-start"><i class="fas mr-1 fa-eye"></i>View Profile</a>
                                                                ...
                                                                <a href="user-ticket-logs.php" class="dropdown-item ml-1 d-flex align-items-center justify-content-start">
