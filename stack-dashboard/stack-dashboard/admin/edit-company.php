                    ...
                    <div class="col-12 px-xl-4 pt-xl-2">
                        <nav aria-label="breadcrumb" class="mt-sm-5 mx-2">
                            <ol class="breadcrumb mb-0">
                                ...
                                <li class="breadcrumb-item blue-text active" aria-current="page">Edit Company Profile</li>
                            </ol>
                        </nav>
                        <div class="card mb-sm-5 mx-2">
                            <div class="card-content collapse show">
                                <div class="card-dashboard">
                                    <div class="row">
                                        <div class="col-12">
                                            <h5 class="mb-2 semi-bold d-grey-text">Edit Company Profile</h5>
                                        </div>
                                    </div>
                                    <form action="company.php">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6 mt-1">
                                                ...
                                                <input type="text" value="Company Name" class="dash-input p-1">
                                            </div>
                                            <div class="col-lg-6 mt-1">
                                            ...
                                            <div class="col-lg-6 mt-1">
                                                ...
                                                <input type="text" value="DEF" class="dash-input p-1">
                                            </div>
                                            <div class="col-lg-6 mt-1">
                                            ...
                                            <div class="col-lg-6 mt-1">
                                                ...
                                                <input type="text" value="ABC" class="dash-input p-1">
                                            </div>
                                            <div class="col-lg-6 mt-1">
                                                <label for="" class="semi-bold d-grey-text">City</label>
                                                <input type="text" value="XYZ" class="dash-input p-1">
                                            </div>
                                            <div class="col-12 mt-1">
                                                <label for="" class="semi-bold d-grey-text">ZIP Code</label>
                                                <input type="number" value="123123" class="dash-input p-1">
                                            </div>
                                            <div class="col-lg-6 mt-1">
                                                <label for="" class="semi-bold d-grey-text">Comments</label>
                                                <textarea name="" id="" cols="30" rows="4" class="dash-input p-1">Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor</textarea>
                                            </div>
                                            <div class="col-lg-6 mt-1">
                                                <label for="" class="semi-bold d-grey-text">Invoice Notes</label>
                                                <textarea name="" id="" cols="30" rows="4" class="dash-input p-1">Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor</textarea>
                                            </div>
                                            <div class="col-12 mt-1">
                                                <button class="site-btn l-blue-btn px-3 py-1" type="button">Save</button>
                                            </div>
                                            <div class="col-12 mt-3 mb-2">
                                                <div class="d-flex align-items-center">
                                            ...
                                            <div class="col-lg-6 mt-1">
                                                ...
                                                <input type="text" value="url.com" class="dash-input p-1">
                                            </div>
                                            <div class="col-12 mt-1">
                                                <label for="" class="semi-bold d-grey-text">Comments</label>
                                                <textarea name="" id="" cols="30" rows="4" class="dash-input p-1">Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et accusam et justo duo dolores et ea rebum. Stet clita kasd gubergren, no sea takimata sanctus est Lorem ipsum dolor sit</textarea>
                                            </div>
                                            <div class="col-12 mt-1">
                                                <button class="site-btn px-2 py-1" type="button">Add another hyperlink</button>
                                            </div>
                                            <div class="col-12 mt-3 mb-2">
                                                <div class="d-flex align-items-center">
                                            ...
                                            <div class="col-12 mt-5 text-center">
                                                <button class="site-btn px-3 py-1" type="submit">Update Details</button>
                                            </div>
                                        </div>
                                    </form>
