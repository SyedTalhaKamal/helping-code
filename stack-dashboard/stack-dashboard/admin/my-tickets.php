                        ...
                        <div class="card my-sm-5 mx-2">
                            <div class="card-content collapse show">
                                <div class="card-dashboard">
                                    <div class="row">
                                        <div class="col-12">
                                            <h5 class="mb-0 semi-bold d-grey-text">My Tickets</h5>
                                        </div>
                                    </div>
                                    <div class="row ml-0 mr-0">
                                        <div class="col-12 text-right">
                                            <button class="site-btn l-blue-btn mb-1 mt-xl-0 p-sm mt-1 px-2 py-1">Export CSV</button>
                                        </div>
