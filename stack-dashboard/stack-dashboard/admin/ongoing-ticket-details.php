                ...
                <div class="row">
                    <div class="col-12">
                        <nav aria-label="breadcrumb" class="mt-sm-5 mx-2">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item blue-text"><a href="ongoing-tickets.php">Ongoing tickets</a></li>
                        ...
                        <div class="card d-block mt-2 mt-sm-0 mx-2">
                            <div class="card-content collapse show">
                                <div class="card-dashboard">
                                    <div class="row">
                                        <div class="col-12">
                                            <h5 class="mb-2 d-grey-text">Ongoing Tickets</h5>
                                        </div>
                                        <div class="col-12">
                                            ...
                                            <div class="row">
                                                <div class="col-xl-4 mt-1 col-lg-6">
